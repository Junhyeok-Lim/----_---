...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\a00559075\\Desktop\\나도코딩_오락실\\pygame_basic\\character.png")
...
# 적 캐릭터
enemy = pygame.image.load("C:\\Users\\a00559075\\Desktop\\나도코딩_오락실\\pygame_basic\\enemy.png")
...
while running:
    dt = clock.tick(60) # 게임화면의 초당 프레임수 // 프레임이 줄어든다고 이동 속도가 줄어들어서는 안됨
...
pygame.time.delay(300) # 게임 종료 후 잠시 대기
